...
const featuredProjects = [
  {
    title: 'Luxeorywalk',
    category: 'Luxury Travel Website',
    image: '/luxeorywalk-screenshot.png',
    summary: 'A luxury travel brand landing experience designed around destination inspiration, aspirational storytelling, and premium customer trust.',
    tags: ['Travel', 'Luxury Brand', 'UI/UX', 'React'],
